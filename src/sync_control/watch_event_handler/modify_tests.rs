...
async fn modify_event() {
    ...
    watch_event_handler
        .handle_watch_events(vec![WatchEvent::Modify {
...
#[tokio::test]
async fn modify_event_with_deleted_index() {
    let dir = TempDir::new_in(env::temp_dir()).unwrap();
    let user_id = Uuid::new_v4();
    let dir_id = Uuid::new_v4();
    let mut index = MockIndex::new();
...
#[tokio::test]
async fn modify_event_with_exists_index() {
    let dir = TempDir::new_in(env::temp_dir()).unwrap();
    let user_id = Uuid::new_v4();
    let dir_id = Uuid::new_v4();
    let mut index = MockIndex::new();
...
#[tokio::test]
async fn modify_event_with_same_index() {
    let dir = TempDir::new_in(env::temp_dir()).unwrap();
    let user_id = Uuid::new_v4();
    let dir_id = Uuid::new_v4();
    let mut index = MockIndex::new();
...
#[tokio::test]
async fn modify_event_with_no_file_no_index() {
    let dir = TempDir::new_in(env::temp_dir()).unwrap();
    let user_id = Uuid::new_v4();
    let dir_id = Uuid::new_v4();
    let mut index = MockIndex::new();
...
#[tokio::test]
async fn modify_event_with_no_file_deleted_index() {
    let dir = TempDir::new_in(env::temp_dir()).unwrap();
    let user_id = Uuid::new_v4();
    let dir_id = Uuid::new_v4();
    let mut index = MockIndex::new();
...
#[tokio::test]
async fn modify_event_with_no_file_exists_index() {
    let dir = TempDir::new_in(env::temp_dir()).unwrap();
    let user_id = Uuid::new_v4();
    let dir_id = Uuid::new_v4();
    let mut index = MockIndex::new();
